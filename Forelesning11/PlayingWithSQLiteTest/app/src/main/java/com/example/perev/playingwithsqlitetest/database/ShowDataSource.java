...
import com.example.perev.playingwithsqlitetest.Episode;
import com.example.perev.playingwithsqlitetest.Show;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by perev on 16/02/2016.
 */
public class ShowDataSource {
    ...
    //Legg over blant andre show-metoder
